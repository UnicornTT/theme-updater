...
$block_style = get_field( 'value_prop_section_choose-variants' );
...
$class_name = 'section section-value-prop';
...
$class_name .= ' section-value-prop--style-' . $block_style;
$section_title = get_field( 'value_prop_section_title' );
$value_props = get_field( 'value_prop_section_props' );
$button_url = get_field( 'value_prop_section_button_link' );
?>
...
<?php elseif ( !empty( $section_title ) && $section_title && $value_props ) : ?>
	<section id="<?= esc_attr( $id ); ?>" class="<?= esc_attr( $class_name ); ?>">
		<?php if ( $block_style == 'v1' ) : ?>
			<?php get_template_part( 'template-parts/blocks/section-value-prop/variants/section-value-prop-v1', '', ['block_id' => $block['id']] ); ?>
		<?php elseif ( $block_style == 'v2' ) : ?>
			<?php get_template_part( 'template-parts/blocks/section-value-prop/variants/section-value-prop-v2', '', ['block_id' => $block['id']] ); ?>
		<?php endif; ?>
	</section>
<?php endif; ?>
