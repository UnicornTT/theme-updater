...
$block_style = get_field( 'our_process_section_choose-variants' );
...
$class_name .= ' section-our-process--style-' . $block_style;
...
<?php elseif ( !empty( $section_title ) && $section_title && $fields_list ) : ?>
	<section id="<?= esc_attr( $id ); ?>" class="<?= esc_attr( $class_name ); ?>">
		<?php if ( $block_style === 'v1' ) : ?>
			<?php get_template_part( 'template-parts/blocks/section-our-process/variants/section-our-process-v1', '', ['block_id' => $block['id']] ); ?>
		<?php elseif ( $block_style === 'v2' ) : ?>
			<?php get_template_part( 'template-parts/blocks/section-our-process/variants/section-our-process-v2', '', ['block_id' => $block['id']] ); ?>
		<?php endif; ?>
	</section>
<?php endif; ?>