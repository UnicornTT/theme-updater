<?php
/**
 * Section Our Work Block Template.
 *
...
$block_style = get_field( 'our_work_section_choose_variants' );
...
$class_name = 'section section-our-work';
...
$class_name .= ' section-our-work--style-' . $block_style;
...
<?php elseif ( !empty( $section_title ) && $section_title ) : ?>
	<section id="<?= esc_attr( $id ); ?>" class="<?= esc_attr( $class_name ); ?>">
		<?php if ( $block_style === 'v1' ) : ?>
			<?php get_template_part( 'template-parts/blocks/section-our-work/variants/section-our-work-v1', '', ['block_id' => $block['id']] ); ?>
		<?php elseif ( $block_style === 'v2' ) : ?>
			<?php get_template_part( 'template-parts/blocks/section-our-work/variants/section-our-work-v2', '', ['block_id' => $block['id']] ); ?>
		<?php endif; ?>
	</section>
<?php endif; ?>