...
<?php if ( $section_content_show && $section_title ) : ?>
	<?php
	...
	<div class="section__body">
		<div class="section-content-block__content js-font-adjustment" data-fj-min="50">
			<div class="container">
				<div class="section-content-block__wrapper">
					...
					<div class="section-content-block__body">
						<div class="section-content-block__body-wrapper">
							<?php if ( $section_content_full ) : ?>
								<div class="section-content-block__scroll">
									<div class="section-content-block__content-cover">
