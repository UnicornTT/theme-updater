...
<?php if ( $section_title && $section_content_show ) : ?>
	<?php
		get_template_part( 'parts/resources/section-background', '', [
			'class_name' => 'section-content-block__bg js-section-content-block__bg-fix',
				...
				<div class="section-content-block__body">
					<div class="section-content-block__cover">
						...
						<?php if ( $section_content_hidden ) : ?>
							...
							?>
							<div class="collapse section-content-block__description-hidden" id="content-block-collapse-<?= esc_attr( $collapse_id ) ?>">
