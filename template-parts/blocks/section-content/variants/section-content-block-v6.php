...
$section_content = get_extended( get_field( 'content_block_section_description' ) );

$section_content_show = $section_content['main'];
$section_content_hidden = $section_content['extended'];

$content_left = '';
$content_right = '';

$content_array = hmt_compound_list_HTML( $section_content_full );

if ( $content_array ) {
	$content_left = implode( '', array_slice( $content_array, 0, round( count( $content_array ) / 2 ) ) );
	$content_right = implode( '', array_slice( $content_array, round( count( $content_array ) / 2 ) ) );
}
?>

<?php if ( $section_title && $section_subtitle && $section_content_full ) : ?>
	<?php
	...
	<div class="section__body">
		<div class="section-content-block__content js-font-adjustment" data-fj-min="35">
			<div class="container">
						...
						<div class="section-content-block__scroll">
							<div class="scrollbar-outer">
								<div class="section-content-block__text">
									<div class="section-content-block__text-left text-content">
										<?= apply_filters( 'the_content', $content_left ); ?>
									</div>

									<div class="section-content-block__text-right text-content">
										<?= apply_filters( 'the_content', $content_right ); ?>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="section-content-block__extended">
							...
							<?php if ( $section_content_hidden ) : ?>
								...
								<div
									...
									id="content-block-collapse-<?= esc_html( $collapse_id ) ?>"
								>
								...
								<div class="section-content-block__button-wrapper">
									<button
										...
										data-target="#content-block-collapse-<?= esc_html( $collapse_id ) ?>"
