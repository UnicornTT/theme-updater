<?php
/**
 * Section Testimonials Block Template.
 *
...
$block_style = get_field( 'testimonials_section_choose_variants' );
...
$class_name = 'section section-testimonials';
...
$class_name .= ' section-testimonials--style-' . $block_style;
$class_name .= ' ' . $section_top_padding . ' ' . $section_bottom_padding;

$section_title = get_field( 'testimonials_section_block_title' );
?>
...
<?php elseif ( !empty( $section_title ) && $section_title ) : ?>
	<section id="<?= esc_attr( $id ); ?>" class="<?= esc_attr( $class_name ); ?>">
		<?php if ( $block_style == 'v1' ) : ?>
			<?php get_template_part( 'template-parts/blocks/section-testimonials/variants/section-testimonials-v1', '', ['block_id' => $block['id']] ); ?>
		<?php elseif ( $block_style == 'v2' ) : ?>
			<?php get_template_part( 'template-parts/blocks/section-testimonials/variants/section-testimonials-v2', '', ['block_id' => $block['id']] ); ?>
		<?php elseif ( $block_style == 'v3' ) : ?>
			<?php get_template_part( 'template-parts/blocks/section-testimonials/variants/section-testimonials-v3', '', ['block_id' => $block['id']] ); ?>
		<?php endif; ?>
	</section>
<?php endif; ?>