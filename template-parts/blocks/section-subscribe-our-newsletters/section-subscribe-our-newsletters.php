<?php
/**
 * Section Social Feed Block Template.
 *
...
$block_style = get_field( 'subscribe_our_newsletters_section_choose-variants' );
...
$class_name = 'section section-subscribe-our-newsletters js-section-subscribe-our-newsletters';
...
$class_name .= ' section-subscribe-our-newsletters--style-' . $block_style;
...
<?php elseif ( !empty( $section_title ) && $section_title && !empty( $section_subtitle ) && $section_subtitle ) : ?>
	<section id="<?= esc_attr( $id ); ?>" class="<?= esc_attr( $class_name ); ?>">
		<?php if ( $block_style == 'v1' ) : ?>
			<?php get_template_part( 'template-parts/blocks/section-subscribe-our-newsletters/variants/section-subscribe-our-newsletters-v1', '', ['block_id' => $block['id'], 'is_preview' => $is_preview] ); ?>
		<?php elseif ( $block_style == 'v2' ) : ?>
			<?php get_template_part( 'template-parts/blocks/section-subscribe-our-newsletters/variants/section-subscribe-our-newsletters-v2', '', ['block_id' => $block['id'], 'is_preview' => $is_preview] ); ?>
		<?php endif; ?>
	</section>
<?php endif; ?>
