...
function hmt_get_svg_inline( $svg_path_or_url ) {
	$path = hmt_convert_url_to_path( $svg_path_or_url );
...
function hmt_svg_inline( $svg_path_or_url ) {
	echo hmt_get_svg_inline( $svg_path_or_url );
}


function hmt_is_svg( $svg_id ) {
	return hmt_get_media_type_by_id( $svg_id ) === 'svg';
}


function hmt_get_svg_as_colorized_png( $svg_path_or_url, $color = '' ) {
	// Look for the file in the theme cache
	$file_hash = hash_file( 'md5', hmt_convert_url_to_path( $svg_path_or_url ) );
	...
	// Generate the file
	$svg = hmt_get_svg_inline( $svg_path_or_url );
