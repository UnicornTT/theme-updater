...
class MEC_skins extends MEC_base
{
    ...
    public function tax_query()
    {
        ...
        {
            $hmt_get_locations_id = $this->hmt_get_locations_id($this->atts['address']);
            $tax_query[] = array(
                'taxonomy'=>'mec_location',
                'field'=>'term_id',
                'terms'=>$hmt_get_locations_id,
            );
        }
    ...
    public function sf_search_field($field, $options)
    {
        ...
        if($field == 'category')
        {
            if($type == 'dropdown')
            {
                ...
                $output .= '<span class="select-wrapper">' . wp_dropdown_categories(array
                (
                    'echo'=>false,
                    'taxonomy'=>'mec_category',
                    'name'=>' ',
     ...
     * @return array
     */
    public function hmt_get_locations_id($address = '')
    {
